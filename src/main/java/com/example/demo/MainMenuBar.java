...
public class MainMenuBar extends MenuBar implements LocaleChangeObserver {
    ...
    public MainMenuBar() {
        ...
        MenuItem projects = addItem(getTranslation("projets", UI.getCurrent().getLocale()));
        projects.setId("projets");
        projects.addClickListener(e -> UI.getCurrent().navigate("projets"));
    }
    ...
    public void localeChange(LocaleChangeEvent event) {
        ...
        System.out.println("LOCAL CHANGED FOR MainMenuBar");
    }
}
